...
export default function Home() {
  return (
    <>
      {/* Hero: 65vh tall showing the bottom of the image, with 160px top padding */}
      <section
        className="relative h-[65vh] overflow-hidden pt-40"
      >
        <Image
          src="/hero.jpg"
      ...
      <section className="py-16 px-4 max-w-5xl mx-auto" id="why-it-works">
        ...
        <p className="text-lg text-center mb-10">
          ...
          cranky. Farm Hopper Pass offers unlimited access for a single price,
      ...
      <section id="signup" className="bg-gray-50 py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mb-8">
            Farm Hopper Pass launches soon—join the list to stay in the loop!
          </p>
      ...
      <footer className="text-center text-sm py-6 bg-white border-t text-gray-500">
        &copy; 2025 Farm Hopper Pass. All rights reserved.
      </footer>
    </>
  )
}
